...
import ExplorerFishHoldMonitor from '@/components/dashboard/ExplorerFishHoldMonitor.vue'
import SprinterFishHoldMonitor from '@/components/dashboard/SprinterFishHoldMonitor.vue'
import MoamariFishHoldMonitor from '@/components/dashboard/MoamariFishHoldMonitor.vue'
import HarvestFishHoldMonitor from '@/components/dashboard/HarvestFishHoldMonitor.vue'
...
import MoamariEquipmentMonitorMkr3 from '@/components/dashboard/MoamariEquipmentMonitorMkr3.vue'
import HarvestEquipmentMonitorMkr3 from '@/components/dashboard/HarvestEquipmentMonitorMkr3.vue'
...
const validViews = ['dashboard', 'challengerDashboard', 'moaconaDashboard', 'jupiterDashboard', 'explorerDashboard', 'sprinterDashboard', 'moamariDashboard', 'harvestDashboard', 'mkr3', 'challengerMkr3', 'moaconaMkr3', 'jupiterMkr3', 'explorerMkr3', 'sprinterMkr3', 'moamariMkr3', 'harvestMkr3', 'tankDetail', 'mainDashboard']
...
const handleBack = () => {
  ...
  } else if (currentShip.value === 'explorer') {
    currentView.value = 'explorerDashboard'
    sessionStorage.setItem('fishhold_view', 'explorerDashboard')
  } else if (currentShip.value === 'sprinter') {
    currentView.value = 'sprinterDashboard'
    sessionStorage.setItem('fishhold_view', 'sprinterDashboard')
  } else if (currentShip.value === 'moamari') {
    currentView.value = 'moamariDashboard'
    sessionStorage.setItem('fishhold_view', 'moamariDashboard')
  } else if (currentShip.value === 'harvest') {
    currentView.value = 'harvestDashboard'
    sessionStorage.setItem('fishhold_view', 'harvestDashboard')
  } else {
    currentView.value = 'dashboard'
...
const handleNavigate = (viewType: string) => {
  ...
  if (viewType === 'dashboard') {
  ...
  } else if (viewType === 'explorerDashboard') {
    currentTank.value = null
    sessionStorage.removeItem('fishhold_tank')
    currentShip.value = 'explorer'
    sessionStorage.setItem('fishhold_ship', 'explorer')
  } else if (viewType === 'sprinterDashboard') {
    currentTank.value = null
    sessionStorage.removeItem('fishhold_tank')
    currentShip.value = 'sprinter'
    sessionStorage.setItem('fishhold_ship', 'sprinter')
  } else if (viewType === 'moamariDashboard') {
    currentTank.value = null
    sessionStorage.removeItem('fishhold_tank')
    currentShip.value = 'moamari'
    sessionStorage.setItem('fishhold_ship', 'moamari')
  } else if (viewType === 'harvestDashboard') {
    currentTank.value = null
    sessionStorage.removeItem('fishhold_tank')
    currentShip.value = 'harvest'
    sessionStorage.setItem('fishhold_ship', 'harvest')
    ...
    currentShip.value = 'sprinter'
    sessionStorage.setItem('fishhold_ship', 'sprinter')
  } else if (viewType === 'moamariMkr3') {
    currentShip.value = 'moamari'
    sessionStorage.setItem('fishhold_ship', 'moamari')
  } else if (viewType === 'harvestMkr3') {
    currentShip.value = 'harvest'
    sessionStorage.setItem('fishhold_ship', 'harvest')
  }

  // 장비 현황판의 플러스(+) 버튼 등을 통해 MKR-3로 넘어올 때 매핑된 정보 전달
  if (viewType === 'mkr3' || viewType === 'challengerMkr3' || viewType === 'moaconaMkr3' || viewType === 'jupiterMkr3' || viewType === 'explorerMkr3' || viewType === 'sprinterMkr3' || viewType === 'moamariMkr3' || viewType === 'harvestMkr3') {
  ...
  <div class="app-container" :class="{ 'app-locked': !isLoggedIn }">
    ...
    <div class="app-main-wrapper">
      ...
      <main class="app-content">
        ...
        <ExplorerFishHoldMonitor v-else-if="currentView === 'explorerDashboard'" @select-tank="handleTankSelect" />
        <SprinterFishHoldMonitor v-else-if="currentView === 'sprinterDashboard'" @select-tank="handleTankSelect" />
        <MoamariFishHoldMonitor v-else-if="currentView === 'moamariDashboard'" @select-tank="handleTankSelect" />
        <HarvestFishHoldMonitor v-else-if="currentView === 'harvestDashboard'" @select-tank="handleTankSelect" />
        ...
        <MoamariEquipmentMonitorMkr3 v-else-if="currentView === 'moamariMkr3'" />
        <HarvestEquipmentMonitorMkr3 v-else-if="currentView === 'harvestMkr3'" />
      </main>
    </div>
  </div>
</template>
