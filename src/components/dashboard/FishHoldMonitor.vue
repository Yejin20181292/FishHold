...
const fishHolds = ref<FishHold[]>([
  ...
  { id: '8p', name: 'No.8 (P)', temp: 3.5, top: '44%', left: '26.3%', width: '6%', height: '5%' },
  { id: '7p', name: 'No.7 (P)', temp: -8.9, top: '44%', left: '35.2%', width: '6%', height: '5%' },
  { id: '6p', name: 'No.6 (P)', temp: -2.2, top: '44%', left: '44.1%', width: '6%', height: '5%' },
  { id: '5p', name: 'No.5 (P)', temp: -3.6, top: '44%', left: '53%', width: '6%', height: '5%' },
  { id: '4p', name: 'No.4 (P)', temp: -1.5, top: '44%', left: '62%', width: '6%', height: '5%' },
  { id: '3p', name: 'No.3 (P)', temp: -0.1, top: '44%', left: '71%', width: '6%', height: '5%' },
  { id: '2p', name: 'No.2 (P)', temp: -10.2, top: '44%', left: '79.3%', width: '6%', height: '5%' },
  ...
  { id: '9s', name: 'No.9 (S)', temp: -1.9, top: '69.2%', left: '17.9%', width: '6%', height: '5%' },
  { id: '8s', name: 'No.8 (S)', temp: -1.0, top: '66%', left: '26.3%', width: '6%', height: '5%' },
  { id: '7s', name: 'No.7 (S)', temp: -12.1, top: '66%', left: '35.2%', width: '6%', height: '5%' },
  { id: '6s', name: 'No.6 (S)', temp: 0.1, top: '66%', left: '44.1%', width: '6%', height: '5%' },
  { id: '5s', name: 'No.5 (S)', temp: 0.1, top: '66%', left: '53%', width: '6%', height: '5%' },
  { id: '4s', name: 'No.4 (S)', temp: 12.5, top: '66%', left: '62%', width: '6%', height: '5%' },
  { id: '3s', name: 'No.3 (S)', temp: -0.6, top: '66%', left: '71%', width: '6%', height: '5%' },
  { id: '2s', name: 'No.2 (S)', temp: -0.8, top: '66%', left: '79.3%', width: '6%', height: '5%' },
]);
