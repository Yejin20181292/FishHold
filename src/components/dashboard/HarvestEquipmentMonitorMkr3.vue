...
const getInitialSelection = (): TankData[] => {
  ...
  // 기본값: PS No11 FH F (인덱스 20)
  return [allTanks.value[20]];
};
...
// Generate realistic mocked tanks for 21 holds
const allTanks = ref<TankData[]>([
  ...
  { id: '20', name: 'SS No11 FH F', temp: -14.9 },
  { id: '21', name: 'PS No11 FH F', temp: -14.5 }
]);
